<?php /* Smarty version Smarty-3.0.8, created on 2019-10-19 17:46:06
         compiled from "C:\xampp\htdocs\icouna\inc\..\assets\themes\admin\internal/users.tpl" */ ?>
<?php /*%%SmartyHeaderCode:16169844615dab2fbe76bab5-54119862%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '038f36cadbeadd4bf15772d674ad8895de08444e' => 
    array (
      0 => 'C:\\xampp\\htdocs\\icouna\\inc\\..\\assets\\themes\\admin\\internal/users.tpl',
      1 => 1571246845,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '16169844615dab2fbe76bab5-54119862',
  'function' => 
  array (
  ),
  'has_nocache_code' => false,
          	...
          	<?php if ($_smarty_tpl->getVariable('area_name')->value=='list'){?>
          		...
          		<input type="hidden" value="<?php echo $_smarty_tpl->getVariable('lang')->value['user'];?>
" id="lang_name">
...
">
												...
												<td><a href="users.html?do=view&id=<?php echo $_smarty_tpl->getVariable('c')->value['id'];?>
...
"><i class="fa fa-trash-o"></i></button>
									...
									<?php }else{ ?>
									<tbody>
									<td align="center" colspan="6"><b><?php echo $_smarty_tpl->getVariable('lang')->value['no_user'];?>
</b></td>
									</tbody><?php }?>
									<tfoot>
										<tr>
...
?>
					...
					<?php }?>
					<section class="panel">
						<header class="panel-heading"> <?php echo $_smarty_tpl->getVariable('lang')->value['edit_user'];?>
...
<?php }?>">
							...
							<div class="form-group">
								<div class="col-sm-10">
									<input type="text" class="form-control" dir="ltr" name="email" placeholder="email@site.com " value="<?php if ($_smarty_tpl->getVariable('n')->value){?><?php echo $_smarty_tpl->getVariable('n')->value['email'];?>
...
<?php }?>">
							...
							<div class="form-group">
								<div class="col-sm-10">
									<input type="password" class="form-control" autocomplete="new-password" name="password" placeholder="<?php echo $_smarty_tpl->getVariable('lang')->value['password'];?>
 " value="">
...
?>
					...
					<?php }?>
					<section class="panel">
						<header class="panel-heading"> <?php echo $_smarty_tpl->getVariable('lang')->value['user_details'];?>
 ( # <?php echo $_smarty_tpl->getVariable('u')->value['id'];?>
 )</header>
						<div class="panel-body">
						<form class="form-horizontal" role="form" method="post" action="users.html?do=update&id=<?php echo $_smarty_tpl->getVariable('u')->value['id'];?>
...
?>
					...
					<?php }?>
					<section class="panel">
						<header class="panel-heading"> <?php echo $_smarty_tpl->getVariable('lang')->value['add_user'];?>
  </header>
						<div class="panel-body">
						<form class="form-horizontal" role="form" method="post" action="users.html?do=add" enctype="multipart/form-data">
							<div class="form-group">
								<div class="col-sm-10">
									<input type="email" class="form-control" name="email"  placeholder="email@site.com" value="<?php echo $_smarty_tpl->getVariable('n')->value['email'];?>
">
								</div>
								<label class="col-sm-2 control-label"> <?php echo $_smarty_tpl->getVariable('lang')->value['email'];?>
 </label>
...
">
							...
							<div class="form-group">
								<div class="col-sm-10">
									<input type="password" class="form-control" autocomplete="off" autocomplete="new-password" name="password" placeholder="  <?php echo $_smarty_tpl->getVariable('lang')->value['password'];?>
 " value="">
								</div>
								<label class="col-sm-2 control-label"> <?php echo $_smarty_tpl->getVariable('lang')->value['password'];?>
</label>
