              ...
              <div class="row">
                <div class="col-md-12">
                  <div class="card">
                    ...
                    <div class="card-body">
                      <form role='form' action="./service_order_add.php<?php if($user_id != 0){echo '?user='.$user_id;}?>" method="post" enctype="multipart/form-data">
                          <br>
                        <?php if(!$user_id){
                                echo '<div class="row">
                                  <div class="col-md-12">
                                           ...
                                           if(!empty($branch))
                                                {
                                                    ...
                                                    {
                                                        echo '<option value="'.$b['branch_serial'].'"';if($b['branch_serial'] == $_order['branch_id']){echo 'selected';}echo'>'.getbranchname($b['branch_serial']).'</option>';
                                                    }
                                                }
                                          ?>
                                    </select>
                          ...
                          <div class="col-md-12">
                            <div class="form-group">
                              ...
                              <select class="browser-default custom-select" name="status">
								  ...
								  <option value="2"<?php if($_order[status] == 2){echo 'selected';}?>><?php echo $lang['DONE'];?></option>
								</select>
                            </div>
                          </div>
                        </div>
